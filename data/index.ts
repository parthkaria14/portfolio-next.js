export const navItems = [
  ...
  {
    id: 4,
    title: "Software Engineer passionate about building real-world impact.",
    description: "",
  ...
  export const projects = [
  {
    ...
    des: "An AI-powered legal chatbot handling 5,000+ queries with 1.5s avg response time.",
    img: "/nyaya.png",
    iconLists: ["/llama.svg", "/re.svg", "/python.svg", "/aws.svg", "/dokcer.svg"],
    link: "https://github.com/parthkaria14/nyaya-sahay-SIH2024",
  },
  {
    id: 2,
    title: "Fauxreal AI – Synthetic Dataset Generator",
    des: "A synthetic data generation tool using CTGANs, WGANs, and VAEs to expand datasets and improve ML models.",
    img: "/fauxreal.png",
    iconLists: ["/pytorch.svg", "/gan.svg", "/python.svg", "/re.svg", "/FastAPI.svg"],
    link: "https://github.com/Devp21/FauxReal-Ai",
  },
  {
    id: 3,
    title: "Law4All – Multilingual Legal Aid System",
    des: "A multilingual AI legal chatbot that delivers clear legal help to underserved communities.",
    img: "/law4allnew.png",
    iconLists: ["/langchain.svg", "/groq.svg", "/python.svg","/re.svg", "/tail.svg"],
    link: "",
  },
  {
    id: 4,
    ...
    img: "/adgenius.png",
    iconLists: ["/langchain.svg", "/groq.svg","/FastAPI.svg", "/python.svg","/re.svg"],
